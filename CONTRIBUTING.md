...
_Welcome hackers! It is **awesome** to have you here! Before you start contributing with this project make sure you read our [Code Of Conduct](https://github.com/mrbyyn/simple-web-project-collection/blob/master/CODE_OF_CONDUCT.md), it is really important to make this inclusive and open to everyone, otherwise, it would not be awesome_
...
1. [Fork](https://github.com/mrbyyn/simple-web-project-collection/fork) and clone the repository.
1. Create a new branch: `git checkout -b my-branch-name`.
1. Add your project into a unique folder.
1. Push to your fork and [submit a pull request](https://github.com/mrbyyn/simple-web-project-collection/compare).
